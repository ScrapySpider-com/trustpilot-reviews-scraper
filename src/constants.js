// Country codes (ISO 3166-1 alpha-2) to full country names
...
export const INDUSTRIES = [
    { value: 'beauty_wellbeing', label: 'Beauty & Wellbeing' },
    ...
    { value: 'food_beverages_tobacco', label: 'Food, Beverages & Tobacco' },
    { value: 'health_medical', label: 'Health & Medical' },
    { value: 'hobbies_crafts', label: 'Hobbies & Crafts' },
    { value: 'home_garden', label: 'Home & Garden' },
    { value: 'home_services', label: 'Home Services' },
    { value: 'legal_services_government', label: 'Legal Services & Government' },
    { value: 'media_publishing', label: 'Media & Publishing' },
    { value: 'money_insurance', label: 'Money & Insurance' },
    { value: 'pets', label: 'Pets' },
    { value: 'public_local_services', label: 'Public & Local Services' },
    { value: 'restaurants_bars', label: 'Restaurants & Bars' },
    { value: 'shopping_fashion', label: 'Shopping & Fashion' },
    { value: 'sports', label: 'Sports' },
    { value: 'travel_vacation', label: 'Travel & Vacation' },
    { value: 'utilities', label: 'Utilities' },
    { value: 'vehicles_transportation', label: 'Vehicles & Transportation' },
];
